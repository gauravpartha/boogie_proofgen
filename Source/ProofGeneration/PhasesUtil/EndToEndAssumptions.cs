...
namespace ProofGeneration.PhasesUtil
{
    public static class EndToEndAssumptions
    {
        ...
        public static Term AxiomAssumption(BoogieContextIsa boogieContext, IProgramAccessor programAccessor, Term normalState)
        {
                return 
        ...
        public static Term GlobalStateAssumption(BoogieContextIsa boogieContext, Term constsAndGlobals, Term normalState)
        {
            return 
